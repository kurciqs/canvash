...
#define CANVASH_MAX_VERTICES 250000
#define CANVASH_VERTEX_SIZE ((3 + 4) * sizeof(float))
#define CANVASH_NUM_FLOATS_IN_VERTEX 7
#define CANVASH_TWODIMENSIONAL_Z_POS (0.0f)
